...
def scan_directory_structure(base_path):
    ...
    for slab_folder in slab_folders:
        ...
        adsorbate = slab_name.replace('Slab_', '')  # Get adsorbate type
        ...
        for ag3pt_folder in ag3pt_folders:
            # Find all site folders under Ag3Pt (e.g., CO_01, CO_02, etc.)
...
def main():
    ...
    base_path = "."  # current directory, you may change this to your actual path
    
    # If you want to specify a particular path, uncomment and modify the line below:
